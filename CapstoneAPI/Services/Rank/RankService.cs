...
namespace CapstoneAPI.Services.Rank
{
    public class RankService : IRankService
    {
        ...
        {
            IEnumerable<int> changedMajorDetailIds = (await _uow.UserMajorDetailRepository
            ...
            {
                IEnumerable<Models.UserMajorDetail> sameMajorDetails = await _uow.UserMajorDetailRepository
            ...
            {
                UserMajorDetailDataSet userMajorDetailDataSet = _mapper.Map<UserMajorDetailDataSet>(await _uow.UserMajorDetailRepository
